...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav
        className="container mx-auto px-4 flex items-center justify-between py-6"
        aria-label="Global"
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-white focus:outline-none focus:underline focus:underline-offset-4 focus:decoration-indigo-500">
              Projects
              <ChevronDownIcon
